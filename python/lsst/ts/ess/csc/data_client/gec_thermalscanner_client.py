...
class GecThermalscannerClient(common.data_client.BaseReadLoopDataClient):
    ...
    def __init__(
        ...
        self.topics.tel_thermocouplesTemperatures.set(
...
"""
    ...
    async def read_data(self) -> None:
        ...
        if len(temperatures) != 94:
            self.log.error(
                "invalid data - expected 94 values, received %d: %s",
                len(temperatures),
                data,
            )
            return
        await self.topics.tel_thermocouplesTemperatures.set_write(
    ...
    async def run(self) -> None:
        ...
        while True:
            ...
            try:
                ...
                while True:
                    temperatures = [
                        str(random.randint(-1000, 1000) / 100.0) for i in range(94)
                    ]
