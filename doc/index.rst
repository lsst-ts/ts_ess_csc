...
The Raspberry Pi 4's then use the code from `ts_ess_controller`_ to retrieve the sensor telemetry from the sensors and to convert the telemetry to a common format.
